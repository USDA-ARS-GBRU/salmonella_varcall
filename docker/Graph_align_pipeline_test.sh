...
export PATH=/home/programs/vg/:/root/miniconda3/bin/:$PATH

#Defining the location of the perl script to compress the pack table:
pack_to_seg=/home/SentericaVariantPipeline/pack_table_to_seg_cov.pl
...
sra=SRR14464606
sradir=/home/SentericaVariantPipeline/
...
time vg pack -t $num_threads -x ${xg} -g ${sra}.filtered.gam -d > ${sra}.coverage.txt
